...
Public Class ClassPegawai
    ...
    Public Sub New()
    End Sub
    Public Sub New(ByVal USERID As Integer, ByVal NAMA_PEGAWAI As String, ByVal TEMPAT_LAHIR As String, ByVal TGL_LAHIR As Date, ByVal FOTO_FILEPATH As String)
        Me.USERID = USERID
    ...
    Public Function GetPegawai() As IEnumerable(Of ClassPegawai)
        ...
        Dim cmd As New SqlCommand("SELECT * FROM T_PEGAWAI", cn)
    ...
    Public Function GetPegawaiByID(id As Integer) As ClassPegawai
        Dim cn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings("EABSEN_API.My.MySettings.ConnString").ConnectionString)
        Dim cmd As New SqlCommand("SELECT * FROM T_PEGAWAI WHERE USERID = @USERID", cn)
        cmd.CommandType = CommandType.Text
